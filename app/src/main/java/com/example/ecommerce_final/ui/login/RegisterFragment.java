...
public class RegisterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.btnRegister.setOnClickListener(v -> {
            ...
            if(binding.txtPassword.getText().toString().equals(binding.txtConfirmPass.getText().toString())){
                User user = new User(
                ...
                Toast.makeText(binding.getRoot().getContext(), "The passwords doesn't match!", Toast.LENGTH_SHORT).show();
            }
        });
